...
public class GroupByUnitTypeTest extends BaseIT {
    private static RequestSpecification spec;

    @DataProvider(name = "groupByUnitTypeTestData")
    public Iterator<Object[]> createData(){
        return getTestcase("POC_Info","groupByUnitType");
    }
    ...
    @Test(dataProvider = "groupByUnitTypeTestData")
