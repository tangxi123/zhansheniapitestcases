...
public class GroupByCarryTypeTest extends BaseIT {
    private static RequestSpecification spec;

    @DataProvider(name = "groupByCarryTypeTestData")
    public Iterator<Object[]> createData(){
        return getTestcase("POC_Info","groupByCarryType");
    }
    ...
    @Test(dataProvider = "groupByCarryTypeTestData")
    ...
    public static void main(String[] args) {
        System.out.println(DateTimeUtil.getCurrentStartOfDay());
    }
