...
public class GroupByRootEventTest extends BaseIT {
    private static RequestSpecification spec;

    @DataProvider(name = "groupByRootEventTestData")
    public Iterator<Object[]> createData() {
        return getTestcase("POC_Info", "groupByRootEvent");
    }
    ...
    @Test(dataProvider = "groupByRootEventTestData")
